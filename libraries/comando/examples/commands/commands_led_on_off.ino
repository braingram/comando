 ...
 * on and off state from python
 *
 * This example shows how to:
 * - send text messages from the arduino to python
 * - receive commands with single argument from python to the arduino
 * - send commands from the arduino to python
 *
 * see examples/commands_led_on_off.py in the comando repository for the
 * corresponding python code
 *
 *
 * After this example, check out libraries/comando/examples/commands_led_blink
 * for how to handle commands with multiple arguments
 */
